...
TankAICurrentMove::TankAICurrentMove() : 
	XMLEntryContainer("TankAIMove", "Offensive AI parameters"),
	resignGroup_("TankAIMoveResign", "Parameters to determine if this AI should resign"),
	useResign_("Enable resigning ability"),
	resignLife_("Don't consider resigning unless you have less than this amount of life"),
	movementGroup_("TankAIMoveMovement", "Parameters to determine if this AI should move.  Tank must have fuel before movement can occur."),
	...
	groupShotGroup_("TankAIMoveGroupShot", "Parameters to determine when to try to kill multiple tanks (in a group)"),
	...
	sniperGroup_("TankAIMoveSniper", "Parameters to determine if this AI should use sniping shots (direct shots at max power)"),
	...
	projectileGroup_("TankAIMoveProjectile", "Parameters to determine how this AI should use projectiles"),
