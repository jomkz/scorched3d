...
MoveTimerAction::MoveTimerAction(unsigned int playerId, unsigned int moveId, 
	...
	performCallback_(true)
{
}

MoveTimerAction::~MoveTimerAction()
{
}

void MoveTimerAction::init()
{
	if (timeout_ == 0) performCallback_ = false;
}

void MoveTimerAction::simulate(fixed frameTime, bool &remove)
{
	timeout_ -= frameTime;
