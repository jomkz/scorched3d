...
#include <uiactions/UITankWeaponSwitcher.h>
#include <tank/Tank.h>
...
UITankWeaponSwitcher::UITankWeaponSwitcher() 
{
}
...
void UITankWeaponSwitcher::switchWeapon(ScorchedContext &context, Tanket *tanket, Accessory *currentWeapon, Accessory *newWeapon) 
{
#ifndef S3D_SERVER
	/*
