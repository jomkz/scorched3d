...
OptionsDisplay::OptionsDisplay() :
	...
	noArenaMoveVisibility_(options_, "NoArenaMoveVisibility", 
		"Do not show the arena area when moving the viewport", RWAccess, false),
	...
	depricatedMoWaterBuffers_(options_, "NoWaterBuffers", 
		"Do not use Vertex Buffers for water (if avaialable)", RAccess | OptionEntry::DataDepricated, false),
	...
	landDetailLevelRamp_(options_, "LandDetailLevelRamp",
		"The amount of error allowed for each land patch as it gains in distance (more is less error)", RWAccess, 128),
