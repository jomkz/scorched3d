		...
		"Allow the user to change sound settings")
{
	...
	soundVolumePanel->addWidget(new GLWLabel(0.0f, 0.0f, LANG_RESOURCE("Sound Volume    ")), 0, SpaceRight, 10.0f);
	...
	ambientSoundVolumePanel->addWidget(new GLWLabel(0.0f, 0.0f, LANG_RESOURCE("Ambient Volume")), 0, SpaceRight, 10.0f);
	...
	musicVolumePanel->addWidget(new GLWLabel(0.0f, 0.0f, LANG_RESOURCE("Music Volume    ")), 0, SpaceRight, 10.0f);
	...
	noSoundBox_ = new GLWCheckBoxText(0.0f, 0.0f, LANG_RESOURCE("No Sound"));
	checkPanel->addWidget(noSoundBox_, 0, SpaceRight, 10.0f);
	noMusicBox_ = new GLWCheckBoxText(0.0f, 0.0f, LANG_RESOURCE("No Music"));
	...
	GLWButton *applyButton = new GLWTextButton(LANG_RESOURCE("Apply"), 235, 10, 110, this,
		GLWButton::ButtonFlagCenterX);
	applyId_ = applyButton->getId();
	buttonPanel->addWidget(applyButton, 0, SpaceRight, 10.0f);
	GLWButton *okButton = new GLWTextButton(LANG_RESOURCE("Ok"), 475, 10, 55, this, 
